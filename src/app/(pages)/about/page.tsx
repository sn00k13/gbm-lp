			...
			<section className="relative bg-gradient-to-br from-orange-50 to-red-50 py-20 px-4">
				<div className="max-w-6xl mx-auto text-center">
					...
					<p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
						We&apos;re revolutionizing the way people shop and connect with
						local businesses. Our mission is to make shopping more convenient,
					...
					<div className="grid md:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p className="text-lg text-gray-600 mb-6 leading-relaxed">
								GoBuyMe was born from a simple observation: shopping should be
								more than just a transaction. It should be an experience that
								connects communities, supports local businesses, and makes life
								easier for everyone involved.
							</p>
							<p className="text-lg text-gray-600 mb-6 leading-relaxed">
								Founded in 2023, we started with a vision to bridge the gap
								between traditional shopping and modern convenience. Today,
								we&apos;re proud to serve thousands of users and businesses
								across the country, creating meaningful connections and driving
								local commerce.
							</p>
				...
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-600 max-w-3xl mx-auto">
							We&apos;re building the future of local commerce, one connection
							at a time.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-2 gap-12">
						<div className="bg-white rounded-2xl p-8 shadow-lg">
							...
							<p className="text-gray-600 leading-relaxed">
								To empower local businesses and communities by creating a
								seamless, technology-driven shopping experience that benefits
								everyone. We believe in the power of local commerce and its
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg">
							...
							<p className="text-gray-600 leading-relaxed">
								To become the leading platform that connects consumers with
								their local businesses, creating a sustainable ecosystem where
								technology enhances human connections and drives economic growth
					...
					<div className="grid md:grid-cols-3 gap-8">
						<div className="text-center">
							...
							<p className="text-gray-600">
								We believe in the power of local communities and work to
								strengthen the bonds between businesses and their customers.
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-gray-600">
								We maintain the highest standards of quality and build trust
			...
			<section className="py-20 px-4 bg-gray-50">
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-600 max-w-3xl mx-auto">
							The passionate individuals behind GoBuyMe who are dedicated to
					...
					<div className="grid md:grid-cols-3 gap-8">
						...
						<div className="bg-white rounded-2xl p-6 shadow-lg text-center">
							...
							<p className="text-gray-600 text-sm">
								Technology expert passionate about creating seamless user
						...
						<div className="bg-white rounded-2xl p-6 shadow-lg text-center">
							...
							<p className="text-[#FF521B] font-semibold mb-3">
								Head of Operations
							</p>
							<p className="text-gray-600 text-sm">
								Operations specialist focused on building strong partnerships
								with local businesses and ensuring smooth operations.
							</p>
						</div>
					</div>
				</div>
