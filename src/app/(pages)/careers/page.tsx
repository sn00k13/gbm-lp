    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-orange-50 to-red-50 py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Become a GoBuyMe delivery partner and earn great money while helping your 
            community. Set your own schedule, work when you want, and grow with us.
          </p>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Join GoBuyMe?</h2>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Requirements to Join</h2>
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Age 18 or Older</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Smartphone & Data</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Clean background check required for customer safety and trust.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Apply to Join Our Team</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to start earning? Fill out the application below and we&apos;ll get back to you within 24 hours.
            </p>
          </div>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <label className="flex items-center">
                    <input type="checkbox" name="availability" value="morning" className="mr-2" />
                    <span className="text-gray-700">Morning (6 AM - 12 PM)</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" name="availability" value="afternoon" className="mr-2" />
                    <span className="text-gray-700">Afternoon (12 PM - 6 PM)</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" name="availability" value="evening" className="mr-2" />
                    <span className="text-gray-700">Evening (6 PM - 12 AM)</span>
                  </label>
                </div>
              </div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Hear from current delivery partners about their experience with GoBuyMe
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                &quot;GoBuyMe has been amazing! I make great money and the flexibility is perfect. 
                The app is easy to use and support is always helpful.&quot;
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                &quot;As a student, this is the perfect job. I work around my classes and 
                earn enough to cover my expenses. The community is great too!&quot;
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                &quot;I&apos;ve been with GoBuyMe for 2 years now. The pay is competitive, 
                the hours are flexible, and I love being part of the local business community.&quot;
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#FF521B] to-orange-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            Join thousands of delivery partners who are already earning great money 
            with GoBuyMe. Apply today and start working tomorrow!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
