            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-[#FF521B] rounded-lg flex items-center justify-center hover:bg-orange-600 transition-colors">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                You can download the GoBuyMe app from the App Store (iOS) or Google Play Store (Android). 
                Simply search for &quot;GoBuyMe&quot; and click the download button.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                ...
                digital wallets (Apple Pay, Google Pay), and cash on delivery for eligible orders.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                Delivery times vary by location and store, but most orders are delivered 
                within 30-60 minutes. You can track your order in real-time through the app.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                Orders can be cancelled within 5 minutes of placement if the store hasn&apos;t 
                started preparing your items. Contact our support team for assistance.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                We&apos;re always looking for great local businesses to partner with! 
                Contact our business development team at business@gobuy.me for more information.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#FF521B] to-orange-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            ...
            if you need any assistance with your GoBuyMe experience.
          </p>
