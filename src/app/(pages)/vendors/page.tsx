      ...
      <section className="relative bg-gradient-to-br from-orange-50 to-red-50 py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Join thousands of restaurants and businesses already thriving with GoBuyMe. 
            Reach more customers, increase sales, and grow your business with our powerful platform.
          </p>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Partner With GoBuyMe?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover how our platform can transform your business and drive growth
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Low Commission</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Powerful Tools for Your Business</h2>
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Easy Menu Management</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Receive orders instantly on your tablet or phone. 
                      Accept, reject, or modify orders with ease.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      Promotions, featured listings, and social media integration.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-orange-100 to-red-100 rounded-2xl p-8">
                <div className="bg-white rounded-xl p-6 shadow-lg">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Partner Success Metrics</h3>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to grow your business? Fill out the application below and we&apos;ll get back to you within 24 hours.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            <form className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="avgOrder" className="block text-sm font-medium text-gray-700 mb-2">
                    Average Order Value
                  </label>
                  <input
                    type="number"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-2xl p-6">
              ...
              <p className="text-gray-600 mb-4">
                &quot;Since partnering with GoBuyMe, our delivery orders have increased by 60%. 
                The platform is easy to use and the delivery service is reliable.&quot;
              </p>
              <div className="text-[#FF521B] font-semibold">+60% Revenue Increase</div>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              ...
              <p className="text-gray-600 mb-4">
                &quot;GoBuyMe helped us reach customers we never had before. 
                Our weekend orders have doubled and the analytics help us plan better.&quot;
              </p>
              <div className="text-[#FF521B] font-semibold">+100% Weekend Sales</div>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              ...
              <p className="text-gray-600 mb-4">
                &quot;The setup was incredibly fast and the support team is amazing. 
                We&apos;ve expanded our delivery radius and our customer base has grown significantly.&quot;
              </p>
              <div className="text-[#FF521B] font-semibold">+45% Customer Growth</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#FF521B] to-orange-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            Join hundreds of successful businesses already thriving with GoBuyMe. 
            Start your partnership today and see the difference tomorrow!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
