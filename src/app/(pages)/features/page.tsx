		...
		<>
			...
			<section className="relative bg-gradient-to-br from-orange-50 to-red-50 py-20 px-4">
				<div className="max-w-6xl mx-auto text-center">
					...
					<p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
						Discover how GoBuyMe transforms your shopping experience with
						cutting-edge technology and innovative solutions designed for modern
						consumers.
					</p>
				</div>
			</section>
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed">
								...
								search algorithm. Filter by location, price, ratings, and more
								to discover the best local options.
							</p>
						</div>
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed">
								Track your orders in real-time with detailed updates. Know
								exactly when your items are being prepared, picked up, and
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed">
								...
								wallets, and cash on delivery. Your financial information is
								always protected.
							</p>
						</div>
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed">
								Read authentic reviews from real customers. Share your
								experiences and help others make informed decisions about local
								businesses.
							</p>
						</div>
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed">
								Stay updated with push notifications for order status,
								promotions, and exclusive deals from your favorite local
								businesses.
							</p>
						</div>
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed">
								Verified businesses, secure transactions, and customer
								protection. Shop with confidence knowing your safety is our top
								priority.
							</p>
						</div>
					</div>
							...
							<div className="space-y-6">
								<div className="flex items-start">
									...
									<div>
										...
										<p className="text-gray-600">
											Compare prices across multiple local businesses and find
											the best deals without leaving your home.
										</p>
									</div>
								</div>
								...
								<div className="flex items-start">
									...
									<div>
										...
										<p className="text-gray-600">
											Help local businesses thrive while enjoying personalized
											service and unique products from your community.
										</p>
									</div>
								</div>
								...
								<div className="flex items-start">
									...
									<div>
										...
										<p className="text-gray-600">
											Fast, reliable delivery to your doorstep with flexible
											scheduling options that fit your busy lifestyle.
										</p>
									</div>
								</div>
							</div>
									...
									<div className="space-y-4">
										<div className="flex items-center justify-between">
											...
											<div className="flex items-center">
												<span className="text-[#FF521B] font-bold mr-2">
													4.8
												</span>
			...
			<section className="py-20 px-4 bg-white">
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-16">
						<h2 className="text-4xl font-bold text-gray-900 mb-6">
							GoBuyMe vs Traditional Shopping
						</h2>
						<p className="text-xl text-gray-600 max-w-3xl mx-auto">
						...
						<div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 border-2 border-[#FF521B]">
							...
							<ul className="space-y-4">
								...
								<li className="flex items-center">
									...
									<span className="text-gray-600">
										Access to hundreds of local stores
									</span>
								</li>
								<li className="flex items-center">
									<svg
