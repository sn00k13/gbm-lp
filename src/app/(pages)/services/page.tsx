			...
			<section className="relative bg-gradient-to-br from-orange-50 to-red-50 py-20 px-4">
				<div className="max-w-6xl mx-auto text-center">
					...
					<p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
						GoBuyMe offers a comprehensive range of delivery services to make your life easier. 
						From food delivery to grocery shopping, we&apos;ve got you covered.
					</p>
				...
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-600 max-w-3xl mx-auto">
							Discover our range of services designed to bring convenience to your doorstep
						</p>
					</div>
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed mb-6">
								Order from your favorite local restaurants and get your meals delivered fast and fresh. 
								From pizza to sushi, we deliver it all.
							</p>
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<h3 className="text-2xl font-bold text-gray-900 mb-4">Grocery Shopping</h3>
							<p className="text-gray-600 leading-relaxed mb-6">
								Shop for groceries from trusted stores and have them delivered to your doorstep. 
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed mb-6">
								Enjoy multiple secure payment options for a seamless checkout experience. 
								Pay with cards, digital wallets, or cash on delivery.
							</p>
							<ul className="space-y-2 text-sm text-gray-600">
								<li className="flex items-center">
									<svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed mb-6">
								Need it fast? Choose express delivery for urgent orders. 
								Get your food delivered in 15-20 minutes.
							</p>
							<ul className="space-y-2 text-sm text-gray-600">
								<li className="flex items-center">
									<svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed mb-6">
								Partner with us to grow your business. We provide delivery solutions 
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="grid md:grid-cols-3 gap-8">
						<div className="text-center">
							...
							<h3 className="text-xl font-bold text-gray-900 mb-4">Browse & Order</h3>
							<p className="text-gray-600">
								Browse through hundreds of restaurants and stores. 
						...
						<div className="text-center">
							...
							<h3 className="text-xl font-bold text-gray-900 mb-4">Enjoy & Repeat</h3>
							<p className="text-gray-600">
								Receive your order at your doorstep. Enjoy your meal and 
								order again whenever you want!
							</p>
						</div>
					</div>
				</div>
