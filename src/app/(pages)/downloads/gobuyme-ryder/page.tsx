					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p className="text-xl text-gray-600 mb-8 leading-relaxed">
								The ultimate delivery partner app. Earn great money with
								flexible hours, reliable support, and a powerful platform
								designed for delivery professionals.
							</p>
							...
							<div className="flex items-start">
								...
								<div>
									...
									<p className="text-gray-600">
										Must be at least 18 years old with a valid government-issued
										ID.
									</p>
								</div>
							</div>
