    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Order food from your favorite local restaurants and get it delivered 
                right to your doorstep. Fast, reliable, and delicious!
              </p>
                        ...
                        <div className="p-4 space-y-4">
                          ...
                          <div className="bg-white rounded-lg p-3 shadow-sm">
                            <div className="flex items-center mb-2">
                              ...
                              <div>
                                <h4 className="font-semibold text-gray-900">Pizza Palace</h4>
                            ...
                            <div className="text-xs text-gray-600 mb-2">Italian • Pizza • 20-30 min</div>
                            <div className="flex justify-between items-center">
                              <span className="text-sm font-semibold text-gray-900">$2.99 delivery</span>
                              <span className="text-xs bg-green-100 text-green-600 px-2 py-1 rounded">Open</span>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <div className="bg-white rounded-lg p-2 text-center">
                              <div className="text-sm font-bold text-gray-900">25 min</div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the features that make ordering food easier and more enjoyable
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Find exactly what you&apos;re craving with our intelligent search. 
                Filter by cuisine, rating, delivery time, and more.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Read authentic reviews from real customers. Make informed decisions 
                about where to order from.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Get updates on your order status, promotions, and restaurant deals. 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="relative">
                  ...
                  <div className="absolute inset-2 bg-white rounded-xl overflow-hidden">
                    <div className="h-full bg-gradient-to-br from-blue-50 to-purple-50">
                      <div className="bg-[#FF521B] text-white p-3">
                        <h4 className="font-semibold text-center">Restaurant Menu</h4>
                      </div>
                      <div className="p-3 space-y-3">
                        <div className="bg-white rounded-lg p-2">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm font-bold text-gray-900">$12.99</div>
                          </div>
                        </div>
                        <div className="bg-white rounded-lg p-2">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm font-bold text-gray-900">$14.99</div>
                          </div>
                        </div>
                        <div className="bg-white rounded-lg p-2">
                          <div className="flex items-center justify-between">
              ...
              <p className="text-center mt-4 font-semibold text-gray-900">Restaurant Menu</p>
            </div>
            ...
            <div className="relative">
                ...
                <div className="w-48 h-80 bg-gray-900 rounded-2xl mx-auto relative shadow-lg">
                  ...
                  <div className="absolute inset-2 bg-white rounded-xl overflow-hidden">
                    <div className="h-full bg-gradient-to-br from-green-50 to-blue-50">
                      <div className="bg-[#FF521B] text-white p-3">
                        <h4 className="font-semibold text-center">Order Tracking</h4>
                      </div>
                      <div className="p-3 space-y-3">
                        <div className="bg-white rounded-lg p-3 text-center">
                          <div className="text-lg font-bold text-gray-900">Order #1234</div>
                          <div className="text-sm text-gray-600">Estimated: 25-30 min</div>
                        </div>
              ...
              <p className="text-center mt-4 font-semibold text-gray-900">Order Tracking</p>
            </div>
            ...
            <div className="relative">
                      ...
                      <div className="p-3 space-y-3">
                        <div className="bg-white rounded-lg p-2">
                          <div className="flex justify-between items-center mb-1">
                            ...
                            <span className="text-xs bg-green-100 text-green-600 px-2 py-1 rounded">Delivered</span>
                          </div>
                          <div className="text-xs text-gray-600">Pizza Palace • 2x Margherita Pizza</div>
                          <div className="text-sm font-bold text-gray-900 mt-1">$28.50</div>
                        </div>
                        <div className="bg-white rounded-lg p-2">
                          <div className="flex justify-between items-center mb-1">
                            <span className="text-sm font-semibold">Order #1233</span>
                            <span className="text-xs bg-green-100 text-green-600 px-2 py-1 rounded">Delivered</span>
                          </div>
                          <div className="text-xs text-gray-600">Burger House • 1x Chicken Burger</div>
                          <div className="text-sm font-bold text-gray-900 mt-1">$12.99</div>
                        </div>
                        <div className="bg-white rounded-lg p-2">
                          <div className="flex justify-between items-center mb-1">
                            <span className="text-sm font-semibold">Order #1232</span>
                            <span className="text-xs bg-green-100 text-green-600 px-2 py-1 rounded">Delivered</span>
                          </div>
                          <div className="text-xs text-gray-600">Sushi Bar • 1x California Roll</div>
              ...
              <p className="text-center mt-4 font-semibold text-gray-900">Order History</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Benefits of Using GoBuyMe</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why millions of customers choose GoBuyMe for their food delivery needs
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Wide Restaurant Selection</h3>
                  <p className="text-gray-600">
                    Choose from hundreds of local restaurants, from fast food to fine dining.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Get your food delivered in 20-40 minutes on average, guaranteed.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Great Deals</h3>
                  <p className="text-gray-600">
                    Enjoy exclusive discounts, free delivery, and special promotions.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#FF521B] to-orange-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            Download GoBuyMe today and discover amazing restaurants in your area!
          </p>
