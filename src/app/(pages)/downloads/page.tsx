  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-orange-50 to-red-50 py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Get the right GoBuyMe app for your needs. Whether you&apos;re a customer, 
            delivery partner, or business owner, we have the perfect app for you.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Choose Your App</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Three powerful apps, one amazing platform. Find the perfect GoBuyMe experience for you.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">GoBuyMe</h3>
                <p className="text-gray-600">Customer App</p>
              </div>
              
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-[#FF521B] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">GoBuyMe Ryder</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">GoBuyMe Restaurant</h3>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Available on All Platforms</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">App Features Comparison</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  ...
                  <th className="text-center py-4 px-6 font-semibold text-gray-900">GoBuyMe</th>
                  <th className="text-center py-4 px-6 font-semibold text-gray-900">GoBuyMe Ryder</th>
                  <th className="text-center py-4 px-6 font-semibold text-gray-900">GoBuyMe Restaurant</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-100">
                  <td className="py-4 px-6 text-gray-700">Order Food & Groceries</td>
                ...
                <tr className="border-b border-gray-100">
                  <td className="py-4 px-6 text-gray-700">Accept Delivery Orders</td>
                  <td className="text-center py-4 px-6">-</td>
                  <td className="text-center py-4 px-6">
                    <svg className="w-5 h-5 text-green-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <tr className="border-b border-gray-100">
                  <td className="py-4 px-6 text-gray-700">Earnings Dashboard</td>
                  <td className="text-center py-4 px-6">-</td>
                  <td className="text-center py-4 px-6">
                    <svg className="w-5 h-5 text-green-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <tr className="border-b border-gray-100">
                  <td className="py-4 px-6 text-gray-700">Analytics & Reports</td>
                  <td className="text-center py-4 px-6">-</td>
                  <td className="text-center py-4 px-6">
                    <svg className="w-5 h-5 text-green-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
