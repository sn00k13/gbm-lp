					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p className="text-xl text-gray-600 mb-8 leading-relaxed">
								The complete business management app for restaurants and local
								businesses. Manage orders, track sales, and grow your business
												...
												<div className="p-4 space-y-4">
													...
													<div className="bg-white rounded-lg p-3 shadow-sm">
														...
														<div className="flex space-x-2">
															<button className="flex-1 bg-green-500 text-white text-xs py-2 rounded">
																Accept
															</button>
															<button className="flex-1 bg-gray-200 text-gray-700 text-xs py-2 rounded">
																Modify
															</button>
														</div>
													</div>
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						...
						<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
							...
							<p className="text-gray-600 leading-relaxed">
								Update your menu, prices, and availability in real-time. Control
								what customers see and when with easy-to-use tools.
							</p>
						</div>
						...
						<div className="space-y-6">
							<div className="flex items-start">
								...
								<div>
									...
									<p className="text-gray-600">
										Restaurants see an average 40% increase in revenue within
										the first 3 months.
									</p>
								</div>
							</div>
							...
							<div className="flex items-start">
								...
								<div>
									...
									<p className="text-gray-600">
										85% of customers return for repeat orders, building loyal
										customer base.
									</p>
								</div>
							</div>
							...
							<div className="flex items-start">
								...
								<div>
									...
									<p className="text-gray-600">
										Get started in just 2 hours with our simple onboarding
										process.
									</p>
								</div>
							</div>
